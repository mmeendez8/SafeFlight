...
import com.example.migue.datacollection.Constants;
import com.example.migue.datacollection.FileManagement.WriteThread;
import com.example.migue.datacollection.PlotData.PlotActivity;
import com.example.migue.datacollection.R;
import com.example.migue.datacollection.DataCollection.Sensors.SensorClass;
        ...
        switch (action){
            ...
            case Constants.RESUME:
                    if (!listreceived) {
                        ...
                        data_list.addAll(intent.getParcelableArrayListExtra(Constants.MESSAGE));
                        writeList();
                        listreceived=true;
                    }
                break;
